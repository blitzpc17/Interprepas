...
@section('nombre-seccion', 'Preparatorias')

@section('title', 'Preparatorias')
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <input type="hidden" name="Id" id="id">
                        ...
                        <div class="form-group">
                          <label for="">Logo Preparatoria</label>
...
<script>
    ...
    function ModificarRegistro(id){        
        ...
        $('#alias').val(registro.Alias)
        $('#region').val(registro.Region)
        $('#id').val(registro.Id) 
        const url = "{{url('')}}/"+registro.Logo;
        console.log(url)
        $('#visor').attr('src', url)
